 ...
 */
const AdvancedAssumptions = ({ inputs, setInputs }) => {
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-xs font-medium text-slate-600 mb-1">Proaptus Manual Review %</label>
            <input
              type="number"
              ...
              min="0"
              max="100"
              title="% of flagged reviews PROAPTUS handles (default 75% - we do 25% spot checks)"
            />
            <span className="text-xs text-slate-500">We do {100 - inputs.ourManualReviewPct}% (spot checks)</span>
          </div>
        </div>
      </div>
