...
const CostDriverAnalysis = ({ model, formatGBP }) => {
  ...
  const pctScanning = totalCapexPrice > 0 ? (model.P_scanning / totalCapexPrice) * 100 : 0;
  ...
  const topDrivers = useMemo(() => {
    ...
    return drivers
      ...
      .slice(0, 3);
  }, [pctScanning, pctManualReview, pctBuildLabor, pctOCR, pctLLM, pctBuildPassthrough, model]);
          ...
          <div className="space-y-3">
            ...
            {model.P_scanning > 0 && (
              <CostDriverRow
                ...
                percentage={pctScanning}
                amount={model.P_scanning}
                indent={true}
              />
            )}
            <CostDriverRow
